...
public class Homework03ByCyclicBarrier {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread thread = new Thread(new ResRunnable(tObject, cyclicBarrier));
        thread.start();
        ...
        result = tObject.result; //这是得到的返回值
    ...
    static class ResRunnable  implements Runnable{
        private TObject tObject;
        private CyclicBarrier cyc;
        public ResRunnable(TObject tObject,CyclicBarrier cyc){
            this.tObject = tObject;
            this.cyc = cyc;
        }
        @Override
